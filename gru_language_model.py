...
if __name__ == "__main__":
    ...
    if machine == 'ccv':
        address1 = '/users/afengler/git_repos/Marijuana_legalization_corpus_study/keras_models/gru_weights' + '_' + str(idx) + '.h5'
    if machine  == 'alex':
        address1 = '/users/afengler/OneDrive/git_repos/marijuana_legalization_corpus_study/keras_models/gru_weight' + '_' + str(idx) + '.h5'
    if machine == 'babak':
